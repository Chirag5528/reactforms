          ...
          <div className="card-body bg-gray-800 text-white pt-4">
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
              ...
              <Link
                ...
                to="https://github.com/themesberg/volt-bootstrap-5-dashboard"
            ...
            <Link
              to="https://themesberg.com/product/admin-dashboard/volt-bootstrap-5-dashboard"
              target="_blank"
              className="
              btn btn-secondary
              d-inline-flex
            ...
            <div className="d-flex justify-content-center">
              ...
              <Link
                to="https://demo.themesberg.com/volt-react-dashboard/#/"
                target="_blank"
              >
                <img
                  alt="Placeholder"
